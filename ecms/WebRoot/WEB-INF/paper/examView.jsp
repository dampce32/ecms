...
<html>
  <head>
	...
	<script type="text/javascript" src="js/examView.js"></script>
</head>
	...
	<div data-options="region:'center',title:'答题区  ',border:false" >
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'north',border:false" class="paperInfo">
				...
				<input id="paperId" type="hidden" value="${param.paperId}">
			...
			<div data-options="region:'south',split:true" class="examToolbar">
				...
				<div class="btnBar">
					<a href="javaScript:void(0)" class="easyui-linkbutton btnBarBtn" id="okExam" data-options="iconCls:'icon-ok',plain:true" style="cursor: pointer;float: right;font-size: 23px">交卷</a>
					<a href="javaScript:void(0)" class="easyui-linkbutton btnBarBtn" id="nextSmall" data-options="iconCls:'icon-down',plain:true"  style="cursor: pointer;float: right;font-size: 23px">下一题</a>
					<a href="javaScript:void(0)" class="easyui-linkbutton btnBarBtn" id="upSmall" data-options="iconCls:'icon-up',plain:true" style="cursor: pointer;float: right;font-size: 23px">上一题</a>
				</div>
			</div>
		</div>
	</div>
