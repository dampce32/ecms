  ...
  $.fn.majorInit = function() {
	  ...
	  $(viewList).datagrid({
		...
		columns:[[
			...
			{field:'dataDictionaryCode',title:'专业编号',width:100,align:"center"},
			{field:'dataDictionaryName',title:'专业名称',width:200,align:"center"},
	...
	var onAdd = function(){
		$(editForm).form('clear');
		$('#dataDictionaryType',editForm).val('Major');
	...
	var search = function(flag){
		...
		var content = {dataDictionaryName:dataDictionaryNameSearch,dataDictionaryCode:dataDictionaryCodeSearch,dataDictionaryType:'Major'};
