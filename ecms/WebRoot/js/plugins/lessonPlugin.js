  ...
  $.fn.lessonInit = function() {
	  ...
	  $(viewList).datagrid({
		...
		columns:[[
			...
			{field:'dataDictionaryCode',title:'课程编号',width:100,align:"center"},
			{field:'dataDictionaryName',title:'课程名称',width:200,align:"center"},
	...
	var onAdd = function(){
		$(editForm).form('clear');
		$('#dataDictionaryType',editForm).val('Lesson');
	...
	var setValue = function(){
		...
		if(''==dataDictionaryCode){
			$.messager.alert('提示','请填写课程编号','warning');
			return false;
		}
	...
	var search = function(flag){
		...
		var content = {dataDictionaryName:dataDictionaryNameSearch,dataDictionaryCode:dataDictionaryCodeSearch,dataDictionaryType:'Lesson'};
