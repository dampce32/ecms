...
(function($) {  
  ...
  $.fn.judgmentCanInit = function() {
	...
	$('#leftPanel',editForm).panel({
	    width:200,  
		height:100,  
	    title:'试题判断'
	});  
	
	$('#rightPanel',editForm).panel({
	    width:700,  
		height:100,  
	    title:'改错'
	});  
	...
	var setValue = function(){
		...
		var answer = $('input:radio[name="answer"]:checked',editForm).val();
		if(null==answer){
			$.messager.alert('提示','请选择答案','warning');
			return false;
		}
