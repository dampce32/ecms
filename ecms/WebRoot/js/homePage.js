...
$(function() {
	...
	//初始化走马灯
	if ($('.csit-img-marquee .slide').length > 0) {
		$('.csit-img-marquee').bxSlider({
			slideWidth: 220,
			auto: true,
			pause: 2000,
			autoDelay: 2000,
	...
	$('#toCompetition').click(function(){
		window.location.href = 'competitionRule.do?competitionId='+currCompetitionId;
		return false;
	});
	$('#moreCompetitionNoticeBtn').click(function(){
		window.location.href = 'competitionNotice.do?competitionId='+currCompetitionId+'&page=0';
		return false;
	});
	$('#moreCompetitorPhotoBtn').click(function(){
		window.location.href = 'competitionPhoto.do?competitionId='+currCompetitionId+'&photoType=competitor&page=0';
		return false;
	});
	$('#moreComperePhotoBtn').click(function(){
		window.location.href = 'competitionPhoto.do?competitionId='+currCompetitionId+'&photoType=compere&page=0';
		return false;
	});
});
